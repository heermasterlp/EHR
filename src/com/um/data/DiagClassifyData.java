...
//	};
	...
	public final static String[] descriptionKeywords = {
			...
			"xonglei%noxonglei:无胸肋痛#okxonglei:左胸轻痛，|胸部疼痛缓解，|咳嗽胸痛减少，|夜间胸痛缓解，|右胸背部隐痛，|，胸痛缓解，|左胸隐痛，|胸部隐痛，|，少许胸痛，|轻度胸肋痛|胸痛缓解|偶胸痛|稍有疼痛|偶有胸痛|胸胁不适轻微|现仍左胸胁不适|，胸闷痛减轻，|现胸背隐痛，#badxonglei:现左胸闷不适，|，胸痛，|胸背部疼痛，|现左胸胁不适，|现左胁肋疼痛不适|现左胸疼痛，|现右侧胸背痛，|现左胸背疼痛|现胸背痛|、颈、胸部疼痛|胸肋痛|现头、颈、胸部疼痛｜。头痛骨痛#worsexonglei:重度胸肋痛|夜间胸痛|右侧胸痛|胸闷胸痛|全身骨痛|胸背痛",
	...
	public final static String[] descKeywords = {
		...
		"badxionglei:现左胸闷不适，|，胸痛，|胸背部疼痛，|现左胸胁不适，|现左胁肋疼痛不适|现左胸疼痛，|现右侧胸背痛，|现左胸背疼痛|现胸背痛|、颈、胸部疼痛|胸肋痛|现头、颈、胸部疼痛｜。头痛骨痛",
